...
describe DocxGenerator::DSL::Paragraph do
  ...
  describe "#generate" do
    it "should return a new paragraph with rich text fragments in it separated by a space" do
      ...
      paragraph.generate.to_s.should include("<w:p><w:r><w:t>The first characters</w:t></w:r><w:r><w:t xml:space=\"preserve\"> </w:t></w:r><w:r><w:t>and the last ones.</w:t></w:r></w:p>")
    end
    ...
    it "should not add a space when it encounters a NoSpace object" do
      ...
      paragraph.generate.to_s.should include("<w:p><w:r><w:t>CO</w:t></w:r><w:r><w:t>2</w:t></w:r></w:p>")
